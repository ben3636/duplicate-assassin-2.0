...
number_of_files=$(wc -l ~/Desktop/ls-hexab | awk ' { print $1 } ')
prog=1
cat ~/Desktop/ls-hexab | while read file1
do
#       echo "Job 2------Scanning Hex...("$prog" / "$number_of_files")"
	echo "("$prog" / "$number_of_files")" > ~/Desktop/job2-status.txt
