...
number_of_files=$(wc -l ~/Desktop/ls-hexac | awk ' { print $1 } ')
prog=1
cat ~/Desktop/ls-hexac | while read file1
do
#       echo "Job 3------Scanning Hex...("$prog" / "$number_of_files")"
	echo "("$prog" / "$number_of_files")" > ~/Desktop/job3-status.txt
