...
number_of_files=$(wc -l ~/Desktop/ls-hexaa | awk ' { print $1 } ')
prog=1
cat ~/Desktop/ls-hexaa | while read file1
do
#       echo "Job 1------Scanning Hex...("$prog" / "$number_of_files")"
	echo "("$prog" / "$number_of_files")" > ~/Desktop/job1-status.txt
